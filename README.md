...
- **10 класс** — https://svetgenmo.github.io/informatika/10/
  - *Базовый уровень*
    ...
    - [Программное обеспечение компьютера](https://svetgenmo.github.io/informatika/10/programmnoe-obespechenie/) — Виды ПО, операционная система, драйверы, установка программ — и первый слой реферата: титульный лист по требованиям конференции
  - *Углублённый уровень*
